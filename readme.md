...
Классическая игра «Сапёр» с расширенным функционалом. Проект реализован на Python и ориентирован на ОС Windows.

## 🛠 Стек технологий
* 🐍 **python 3.12**
* 🖥️ **pyqt6** (6.11) — графический интерфейс *(полный список зависимостей в `requirements.txt`)*
...
Скачайте архив из раздела Releases, распакуйте и запустите `dist/main.exe`.
...
* Наличие системы достижений, включащей 3 уникальных ачивки (2 победы, прохождение всех урвоней сложностей, корректная установка 10 флагов)
* Присутствует локальный рейтинг, сегментированный по уровню сложности

## 🗺 Планы
- [ ] Интеграция глобальной онлайн-таблицы лидеров
